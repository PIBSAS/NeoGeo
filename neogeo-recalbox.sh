...
echo "Roms"
echo
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/2020bb.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/3countb.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/4play.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/alpham2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/androdun.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/aodk.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/aof2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/aof3.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/aof.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/b2b.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/bakatono.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/bangbead.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/bjourney.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/blazstar.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/breakers.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/breakrev.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/bstars2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/bstars.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/burningf.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/cnbe.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/columnsn.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/crswd2bl.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/crsword.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/ct2k3sp.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/cthd2003.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/ctomaday.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/cyberlip.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/diggerma.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/doubledr.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/eightman.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/fatfursp.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/fatfury1.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/fatfury2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/fatfury3.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/fbfrenzy.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/fightfev.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/flipshot.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/froman2b.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/fswords.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/galaxyfg.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/ganryu.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/garou.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/ghostlop.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/goalx3.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/gowcaizr.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/gpilots.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/gururin.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/ironclad.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/irrmaze.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/janshin.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/jockeygp.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/joyjoy.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/kabukikl.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/karnovr.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/kizuna.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/kof2000.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/kof2001.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/kof2002.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/kof2003.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/kof94.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/kof95.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/kof96.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/kof97.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/kof98.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/kof99.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/kogplus.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/kog.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/kotm2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/kotm.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/lastblad.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/lastbld2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/lasthope.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/lbowling.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/legendos.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/lresort.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/ltorb1.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/magdrop2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/magdrop3.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/maglord.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/mahretsu.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/matrim.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/miexchng.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/minasan.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/moshougi.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/mslug2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/mslug3b6.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/mslug3.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/mslug4.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/mslug5.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/mslugx.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/mslug.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/mutnat.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/nam1975.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/ncombat.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/ncommand.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/neobombe.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/neocup98.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/neodrift.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/neomrdo.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/neonopon.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/neopong.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/neotet.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/neothndr.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/neotris.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/ngem2k.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/ngfrog.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/ninjamas.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/nitd.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/overtop.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/panicbom.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/pbobbl2n.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/pbobblen.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/pgoal.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/pnyaa.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/poknight.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/popbounc.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/preisle2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/pspikes2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/pulstar.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/puzzldpr.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/puzzledp.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/ragnagrd.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/rbff1.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/rbff2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/rbffspec.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/ridhero.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/roboarmy.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/rotd.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/s1945p.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/samsh5sp.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/samsho2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/samsho3.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/samsho4.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/samsho5.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/samsho.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/savagere.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/sdodgeb.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/sengoku2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/sengoku3.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/sengoku.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/shocktr2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/shocktro.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/socbrawl.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/sonicwi2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/sonicwi3.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/spinmast.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/ssideki2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/ssideki3.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/ssideki4.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/ssideki.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/stakwin2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/stakwin.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/strhoop.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/superspy.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/svc.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/timesupd.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/tophuntr.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/totc.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/tpgolf.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/trally.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/turfmast.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/twinspri.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/twsoc96.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/viewpoin.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/vliner.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/wakuwak7.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/wh1.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/wh2j.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/wh2.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/whp.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/wjammers.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/zedblade.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/zintrckb.zip
wget -P ../roms/neogeo/ ${RUTA_ARCH}neogeo/zupapa.zip
echo
echo "Videos"
echo
