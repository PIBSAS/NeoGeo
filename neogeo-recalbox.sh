...
echo
rm ../roms/neogeo2020bb.zip
rm ../roms/neogeo3countb.zip
rm ../roms/neogeo4play.zip
rm ../roms/neogeoalpham2.zip
rm ../roms/neogeoandrodun.zip
rm ../roms/neogeoaodk.zip
rm ../roms/neogeoaof2.zip
rm ../roms/neogeoaof3.zip
rm ../roms/neogeoaof.zip
rm ../roms/neogeob2b.zip
rm ../roms/neogeobakatono.zip
rm ../roms/neogeobangbead.zip
rm ../roms/neogeobjourney.zip
rm ../roms/neogeoblazstar.zip
rm ../roms/neogeobreakers.zip
rm ../roms/neogeobreakrev.zip
rm ../roms/neogeobstars2.zip
rm ../roms/neogeobstars.zip
rm ../roms/neogeoburningf.zip
rm ../roms/neogeocnbe.zip
rm ../roms/neogeocolumnsn.zip
rm ../roms/neogeocrswd2bl.zip
rm ../roms/neogeocrsword.zip
rm ../roms/neogeoct2k3sp.zip
rm ../roms/neogeocthd2003.zip
rm ../roms/neogeoctomaday.zip
rm ../roms/neogeocyberlip.zip
rm ../roms/neogeodiggerma.zip
rm ../roms/neogeodoubledr.zip
rm ../roms/neogeoeightman.zip
rm ../roms/neogeofatfursp.zip
rm ../roms/neogeofatfury1.zip
rm ../roms/neogeofatfury2.zip
rm ../roms/neogeofatfury3.zip
rm ../roms/neogeofbfrenzy.zip
rm ../roms/neogeofightfev.zip
rm ../roms/neogeoflipshot.zip
rm ../roms/neogeofroman2b.zip
rm ../roms/neogeofswords.zip
rm ../roms/neogeogalaxyfg.zip
rm ../roms/neogeoganryu.zip
rm ../roms/neogeogarou.zip
rm ../roms/neogeoghostlop.zip
rm ../roms/neogeogoalx3.zip
rm ../roms/neogeogowcaizr.zip
rm ../roms/neogeogpilots.zip
rm ../roms/neogeogururin.zip
rm ../roms/neogeoironclad.zip
rm ../roms/neogeoirrmaze.zip
rm ../roms/neogeojanshin.zip
rm ../roms/neogeojockeygp.zip
rm ../roms/neogeojoyjoy.zip
rm ../roms/neogeokabukikl.zip
rm ../roms/neogeokarnovr.zip
rm ../roms/neogeokizuna.zip
rm ../roms/neogeokof2000.zip
rm ../roms/neogeokof2001.zip
rm ../roms/neogeokof2002.zip
rm ../roms/neogeokof2003.zip
rm ../roms/neogeokof94.zip
rm ../roms/neogeokof95.zip
rm ../roms/neogeokof96.zip
rm ../roms/neogeokof97.zip
rm ../roms/neogeokof98.zip
rm ../roms/neogeokof99.zip
rm ../roms/neogeokogplus.zip
rm ../roms/neogeokog.zip
rm ../roms/neogeokotm2.zip
rm ../roms/neogeokotm.zip
rm ../roms/neogeolastblad.zip
rm ../roms/neogeolastbld2.zip
rm ../roms/neogeolasthope.zip
rm ../roms/neogeolbowling.zip
rm ../roms/neogeolegendos.zip
rm ../roms/neogeolresort.zip
rm ../roms/neogeoltorb1.zip
rm ../roms/neogeomagdrop2.zip
rm ../roms/neogeomagdrop3.zip
rm ../roms/neogeomaglord.zip
rm ../roms/neogeomahretsu.zip
rm ../roms/neogeomatrim.zip
rm ../roms/neogeomedia
rm ../roms/neogeomiexchng.zip
rm ../roms/neogeominasan.zip
rm ../roms/neogeomoshougi.zip
rm ../roms/neogeomslug2.zip
rm ../roms/neogeomslug3b6.zip
rm ../roms/neogeomslug3.zip
rm ../roms/neogeomslug4.zip
rm ../roms/neogeomslug5.zip
rm ../roms/neogeomslugx.zip
rm ../roms/neogeomslug.zip
rm ../roms/neogeomutnat.zip
rm ../roms/neogeonam1975.zip
rm ../roms/neogeoncombat.zip
rm ../roms/neogeoncommand.zip
rm ../roms/neogeoneobombe.zip
rm ../roms/neogeoneocup98.zip
rm ../roms/neogeoneodrift.zip
rm ../roms/neogeoneomrdo.zip
rm ../roms/neogeoneonopon.zip
rm ../roms/neogeoneopong.zip
rm ../roms/neogeoneotet.zip
rm ../roms/neogeoneothndr.zip
rm ../roms/neogeoneotris.zip
rm ../roms/neogeongem2k.zip
rm ../roms/neogeongfrog.zip
rm ../roms/neogeoninjamas.zip
rm ../roms/neogeonitd.zip
rm ../roms/neogeoovertop.zip
rm ../roms/neogeopanicbom.zip
rm ../roms/neogeopbobbl2n.zip
rm ../roms/neogeopbobblen.zip
rm ../roms/neogeopgoal.zip
rm ../roms/neogeopnyaa.zip
rm ../roms/neogeopoknight.zip
rm ../roms/neogeopopbounc.zip
rm ../roms/neogeopreisle2.zip
rm ../roms/neogeopspikes2.zip
rm ../roms/neogeopulstar.zip
rm ../roms/neogeopuzzldpr.zip
rm ../roms/neogeopuzzledp.zip
rm ../roms/neogeoragnagrd.zip
rm ../roms/neogeorbff1.zip
rm ../roms/neogeorbff2.zip
rm ../roms/neogeorbffspec.zip
rm ../roms/neogeoridhero.zip
rm ../roms/neogeoroboarmy.zip
rm ../roms/neogeorotd.zip
rm ../roms/neogeos1945p.zip
rm ../roms/neogeosamsh5sp.zip
rm ../roms/neogeosamsho2.zip
rm ../roms/neogeosamsho3.zip
rm ../roms/neogeosamsho4.zip
rm ../roms/neogeosamsho5.zip
rm ../roms/neogeosamsho.zip
rm ../roms/neogeosavagere.zip
rm ../roms/neogeosdodgeb.zip
rm ../roms/neogeosengoku2.zip
rm ../roms/neogeosengoku3.zip
rm ../roms/neogeosengoku.zip
rm ../roms/neogeoshocktr2.zip
rm ../roms/neogeoshocktro.zip
rm ../roms/neogeosocbrawl.zip
rm ../roms/neogeosonicwi2.zip
rm ../roms/neogeosonicwi3.zip
rm ../roms/neogeospinmast.zip
rm ../roms/neogeossideki2.zip
rm ../roms/neogeossideki3.zip
rm ../roms/neogeossideki4.zip
rm ../roms/neogeossideki.zip
rm ../roms/neogeostakwin2.zip
rm ../roms/neogeostakwin.zip
rm ../roms/neogeostrhoop.zip
rm ../roms/neogeosuperspy.zip
rm ../roms/neogeosvc.zip
rm ../roms/neogeotimesupd.zip
rm ../roms/neogeotophuntr.zip
rm ../roms/neogeototc.zip
rm ../roms/neogeotpgolf.zip
rm ../roms/neogeotrally.zip
rm ../roms/neogeoturfmast.zip
rm ../roms/neogeotwinspri.zip
rm ../roms/neogeotwsoc96.zip
rm ../roms/neogeoviewpoin.zip
rm ../roms/neogeovliner.zip
rm ../roms/neogeowakuwak7.zip
rm ../roms/neogeowh1.zip
rm ../roms/neogeowh2j.zip
rm ../roms/neogeowh2.zip
rm ../roms/neogeowhp.zip
rm ../roms/neogeowjammers.zip
rm ../roms/neogeozedblade.zip
rm ../roms/neogeozintrckb.zip
rm ../roms/neogeozupapa.zip
